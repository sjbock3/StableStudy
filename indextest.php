...
$app->get('/search', function(){
    ...
    $buildings = array("building_name"=>"NOT NULL");
    $buildingquery = "";
    ...
    if (isset($params['building_name'])){
        ...
        $mysqli->query("CREATE VIEW search AS SELECT * FROM LOCATIONS WHERE '$buildingquery'");
    }
    else{
        $mysqli->query("CREATE VIEW search AS SELECT * FROM LOCATIONS");
    }
    ...
    echo json_encode($finalArr);
    $mysqli->query("DROP TABLE search");
    return;
